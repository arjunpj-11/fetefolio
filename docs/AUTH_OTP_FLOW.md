...
6. Nodemailer sends the OTP. In local development without SMTP, the API console prints a mail preview so the flow remains testable.
...
- Configure authenticated SMTP. Console mail preview is intended only for local development.
